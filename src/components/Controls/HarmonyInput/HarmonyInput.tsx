...
const HARMONY_TOOLTIPS: Record<HarmonyMethod, string> = {
    ...
    analogous: 'Uses hues next to each other on the wheel for a harmonious, natural look.',
    ...
    'split-complementary': 'Primary plus the two neighbors of its opposite for contrast with less tension.',
    'split-triadic': 'Variation of triadic with adjusted spacing for softer contrast.',
    ...
    return (
        <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
                <label htmlFor="harmony-toggles" className="text-base lg:text-xs font-mono text-neutral-600">
                    Color Harmony
                </label>
            </div>
            <Tooltip.Provider>
                <ToggleGroup
                    ...
                    value={[harmonyMethod]}
                    onValueChange={(value) => setHarmonyMethod((value as HarmonyMethod[])?.[0] ?? 'auto')}
                >
