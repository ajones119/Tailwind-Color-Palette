...
export default function ColorRowsSection() {
  ...
  return (
    <section className="my-2 space-y-4 max-w-5xl" aria-labelledby="color-rows-heading">
      <h2 id="color-rows-heading" className="text-2xl font-bold font-title mb-8 sr-only">
        Color Rows
      </h2>
