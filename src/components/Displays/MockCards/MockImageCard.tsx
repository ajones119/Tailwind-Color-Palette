  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: `url(${BackgroundSVG})`, backgroundSize: "40px 40px", backgroundPosition: 'center', backgroundColor: primary[4], }}
      />
      ...
      <div className="text-sm leading-relaxed mb-4" style={{ color: neutral[6] }}>
        How consistent color palettes help teams ship faster and maintain brand cohesion.
      </div>
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-xs font-medium" style={{ color: neutral[7] }}>Alex Kim · 4 min read</span>
        </div>
        </div>
      </div>
    </div>
