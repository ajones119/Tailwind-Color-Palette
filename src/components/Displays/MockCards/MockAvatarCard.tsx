...
export default function MockAvatarCard() {
  ...
  return (
    <div
      className="relative rounded-xl font-sans border overflow-hidden"
    ...
    >
      ...
      <div className="z-10 relative">
        <h2 className="text-4xl lg:text-2xl font-bold lg:p-6 p-6" style={{ color: primary[6] }}>Design With Passion</h2>
      </div>
