...
const FONTS = [
  { var: '--font-title', value: '"Space Grotesk", ui-sans-serif, system-ui, sans-serif' },
  { var: '--font-body',  value: '"DM Sans", ui-sans-serif, system-ui, sans-serif' },
...
export default function ThemeExport() {
  ...
  return (
    <section className="rounded-xl border overflow-hidden" aria-labelledby="theme-export-heading">
      <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3 border-b bg-neutral-100 border-neutral-300">
        <h2 id="theme-export-heading" className="text-base sm:text-lg font-bold text-neutral-800 min-w-0 truncate">
          Tailwind v4 theme
        </h2>
