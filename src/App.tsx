...
function App() {
  return (
    <div className="p-4 md:p-16 font-body">
      <div className="mt-8">
        <h1 className="text-4xl font-bold font-title">Tailwind Color Palette</h1>
      </div>
        ...
        <div className="flex flex-col gap-16 lg:gap-0">
          ...
          <div className="mx-4 lg:mt-32">
            ...
            <p className="text-neutral-600 mb-4 max-w-2xl">
              Paste this into your CSS (e.g. in <code className="font-mono bg-neutral-200 px-1 rounded text-sm">@import &quot;tailwindcss&quot;;</code> or your main stylesheet) to use these colors as Tailwind v4 theme variables.
            </p>
            <ThemeExport />
          </div>
        </div>
